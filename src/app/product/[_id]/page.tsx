...
import LoadAndZoomImage from "@/components/LoadImage";
...
const ZoomProductPage = async ({ searchParams }: any) => {
  const {
    _id,
    title,    
    brand,
  ...
  return (
    <Container>
      <div className="w-full grid md:grid-cols-3 gap-2 bg-gray-100 min-h-[500px] rounded-lg">
        <div className="flex items-center justify-center bg-gray-200 rounded-lg relative group">
          {/* <Image
            src={image}
            alt="loadImage"
            width={500}
...
export default ZoomProductPage;
